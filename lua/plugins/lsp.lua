    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("<leader>ld", function() require("fzf-lua").lsp_document_diagnostics() end, "Document diagnostics")
          map("<leader>lD", function() require("fzf-lua").lsp_workspace_diagnostics() end, "Workspace diagnostics")
